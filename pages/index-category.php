                      ...
                      <table class="table table-striped">
                        ...
                        <?php foreach ($Categories as $Categori): ?>
                          <tr>
                            ...
                            <td>
                              <button href="#" onclick="modalDetails(<?= $Categori['id_category'] ?>, '<?= $Categori['name_category'] ?>') " class="btn btn-primary mr-1"><i class="fas fa-info-circle"></i> Detail</button>
                              <a href="edit-category.php?id_category=<?= $Categori['id_category'] ?>" class="btn btn-success mr-1"><i class="far fa-edit"></i> Edit</a>
                              <a href="../services/delete-category.php?id_category=<?= $Categori['id_category'] ?>" class="btn btn-danger mr-1"><i class="fas fa-trash"></i></a>
                            </td>
                          </tr>
                          <?php $num++ ?>
