...
class Categories extends Model
{
  ...
  {
    $query = "SELECT * FROM categories JOIN pivot_posts_tags ON categories.id_category = pivot_posts_tags.tag_id_pivot JOIN posts ON posts.id_post = pivot_posts_tags.post_id_pivot WHERE pivot_posts_tags.post_id_pivot = posts.id_post";
